...
# Dictionary LOAD
with open('pickleFile/word_index_v2.pickle', 'rb') as fr:
    word_index = pickle.load(fr)

with open('pickleFile/index_word_v2.pickle', 'rb') as fr:
    index_word = pickle.load(fr)

with open('pickleFile/category_to_idx_v2.pickle', 'rb') as fr:
    category_to_idx = pickle.load(fr)

with open('pickleFile/idx_to_category_v2.pickle', 'rb') as fr:
...
model = load_model('model/cnn1d_model_37category_0.h5')
