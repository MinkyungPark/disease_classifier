...
model_name = 'data/nin20200319_36category.model'
...
# %%
print(model.wv.similarity('입냄새','구취'))
print(model.wv.similarity('체중','몸무게'))
print(model.wv.similarity('체중','구취'))
print(model.wv.similarity('아프다','회복'))
print()
print(model.wv.most_similar('아프다'))
print()
...
print(model.wv.doesnt_match('치료 재활 치료법 할인'.split())) # 혈압
print(model.wv.doesnt_match('허리디스크 방사통 통증 추천'.split()))