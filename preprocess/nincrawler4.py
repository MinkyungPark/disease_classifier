...
# lis = [['천명','거친숨소리','쌕쌕소리'], ['가래','객담','목에가래','목에분비물','기침분비물'], ['체중감소','살이빠짐','몸무게가줌'], \
...
# ['언어장애','발음부정확','발음이상','말더듬'],['반신마비','반신불수','편마비',''],['목마름','계속갈증','계속목마름']]

# lis = [['가래'],['가슴통증'],['고열'],['관절통'],['구취'],['구토'],['기침'],['다뇨'],['다식'],['다음'],['두통'],['반신마비'],['방사통'],['복부팽만'],\
#     ['복시'],['복통'],['설사'],['소양감'],['소화불량'],['손발저림'],['시력감소'],['시야장애'],['식욕부진'],['심계항진'],['어지럼증'],['언어장애'],\
#         ['연하곤란'],['오심'],['요통'],['운동장애'],['잇몸염증'],['천명'],['체중감소'],['피로감'],['하지마비'],['호흡곤란']]



# lis = [['고혈압'],['치은염'],['급성기관지염'],['협심증'],['당뇨병'],['위염'],['십이지장염'],['위식도역류'],['뇌졸중'],['척추디스크'],['치주염'],\
#     ['알레르기성 접촉성 피부염'],['급성인후염'],['알러지성 결막염'],['백내장'],['알러지성비염'],['전립선비대증'],['비루관폐쇄'],['충치'],\
#         ['피부백선증'],['골다공증'],['고지혈증'],['편도선염'],['급성위장염'],['만성위장염'],['결장염'],['두드러기'],['각막염'],['과민성대장증후군'],\
#             ['천식'],['급성방광염'],['녹내장'],['외이염'],['알츠하이머치매'],['위궤양'],['부비동염'],['건초염'],['우울증'],['불면증'],['대상포진']]
...
def run(lis):
    for li in lis:
        ...
        filename = "nin" + datetime.today().strftime("%Y%m%d%H%M") + keywords[0] + ".csv"
        df = df.dropna()
