...
def concat():
    ...
    df10 = makeCategory('nin202003131907다음','다음')
    ...
    df22 = makeCategory('nin202003161858다음','다음')
    df23 = makeCategory('nin202003161907소양감','소양감')
    df24 = makeCategory('nin202003162030피로감','피로감')
    df25 = makeCategory('nin202003162112시야장애','시야장애')
    df26 = makeCategory('nin202003162223다뇨','다뇨')
    df27 = makeCategory('nin202003162322다식','다식')
    df28 = makeCategory('nin202003170046복통','복통')
    df29 = makeCategory('nin202003170155설사','설사')
    df30 = makeCategory('nin202003170312복부팽만','복부팽만')
    df31 = makeCategory('nin202003170410식욕부진','식욕부진')
    df32 = makeCategory('nin202003170451구토','구토')
    df33 = makeCategory('nin202003170547연하곤란','연하곤란')
    df34 = makeCategory('nin202003170716운동장애','운동장애')
    df35 = makeCategory('nin202003170757복시','복시')
    df36 = makeCategory('nin202003170920시력감소','시력감소')
    df37 = makeCategory('nin202003171020언어장애','언어장애')
    df38 = makeCategory('nin202003171105반신마비','반신마비')
...
total_df.to_csv('data3/total_37category.csv', index=False, encoding='utf-8')